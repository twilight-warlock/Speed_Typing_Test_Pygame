...
class Game:
    ...
    def get_sentence(self):
        f = open('Random_sentences.txt').read()
        sentences = f.split('\n')
    ...
    def show_results(self, screen):
        if(not self.end):
            ...
            data = [self.accuracy, 100-self.accuracy]
    ...
    def reset_game(self):
        ...
        pygame.draw.rect(self.screen, (255, 192, 25), (150, 250, 750, 50), 2)
    ...
    def run(self):
        ...
        while(self.running):
            ...
            self.screen.fill((0, 0, 0), (150, 250, 750, 50))
            pygame.draw.rect(self.screen, self.HEAD_C, (150, 250, 750, 50), 2)
